...
# Map for carol
png(file.path(maps.out, "Map_Phenology_OakCollection_CarolNemec.png"), height=8, width=11, unit="in", res=220)
plot(quercus, pch=19, cex=0.5)
plot(woods, add=T, col="green4")
# plot(collections[!is.na(collections$collection) & collections$collection=="Quercus",], add=T, col="indianred")
plot(roads, add=T, lwd=3, col="gray50")
...
png(file.path(maps.out, "Map_Phenology_OakCollection_JoanDorrell.png"), height=8, width=11, unit="in", res=220)
plot(quercus, pch=19, cex=0.5)
plot(woods, add=T, col="green4")
# plot(collections[!is.na(collections$collection) & collections$collection=="Quercus",], add=T, col="indianred")
plot(roads, add=T, lwd=3, col="gray50")
...
png(file.path(maps.out, "Map_Phenology_OakCollection_BrockBigsby.png"), height=8, width=11, unit="in", res=220)
plot(quercus, pch=19, cex=0.5)
plot(woods, add=T, col="green4")
# plot(collections[!is.na(collections$collection) & collections$collection=="Quercus",], add=T, col="indianred")
plot(roads, add=T, lwd=3, col="gray50")
