...
path.figs <- "/Volumes/GoogleDrive/My Drive/LivingCollections_Phenology/Reports/2019_01_MidYear_Report/figures"
...
pdf(file.path(path.figs, "Histograms_Observations_LeafPresent_by_Observer_by_Species.pdf"), width=8.5, height=11)
