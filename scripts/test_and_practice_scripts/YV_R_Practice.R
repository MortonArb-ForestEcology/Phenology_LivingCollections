...
path.figs <- "G://My Drive/LivingCollections_Phenology/Figures/Practice_Figures"
...
png(file.path(path.figs,"YV_obs_by_week_childrens_garden.png"), height=4, width=6, units="in", res=320)
...
png(file.path(path.figs,"YV_obs_by_week_meadow_lake.png"), height=4, width=6, units="in", res=320)
...
png(file.path(path.figs,"YV_obs_by_date_childrens_garden.png"), height=4, width=6, units="in", res=320)
...
png(file.path(path.figs,"YV_obs_by_date_meadow_lake.png"), height=4, width=6, units="in", res=320)
...
#graphing
png(file.path(path.figs,"YV_obs_by_date_per_q-macrocarpa.png"), height=4, width=6, units="in", res=320)
...
#graphing
png(file.path(path.figs,"YV_obs_by_date_per_individual.png"), height=4, width=6, units="in", res=320)
