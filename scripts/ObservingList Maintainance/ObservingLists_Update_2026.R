...
# Resetting to 2023 to see what's going on
quercusObs <- read_csv("~/Google Drive/My Drive/LivingCollections_Phenology/Observing Lists/OLD/Quercus/ObservingList_Quercus_2023.csv")
ulmusObs <- read_csv("~/Google Drive/My Drive/LivingCollections_Phenology/Observing Lists/OLD/Ulmus/ObservingList_Ulmus_2023.csv")
acerObs <- read_csv("~/Google Drive/My Drive/LivingCollections_Phenology/Observing Lists/OLD/Acer/ObservingList_Acer_2023.csv")
# summary(quercusObs)
...
# # Getting rid of this because it was creating too many false positives
