...
min(dat.fb$Date.Observed[dat.fb$Year == 2024], na.rm = TRUE)
max(dat.fb$Date.Observed[dat.fb$Year == 2024], na.rm = TRUE)
range(dat.fb$Date.Observed[dat.fb$Year == 2024], na.rm = TRUE)
