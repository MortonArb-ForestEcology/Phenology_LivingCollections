...
dat.llc <- dat.lc[dat.lc$yday >= 220 & dat.lc$yday <= 300, ]
summary(dat.llc)
...
leaf.color$Date <- as.Date(paste0("2024-", leaf.color$yday), format="%Y-%j")
...
ggplot(data=leaf.color) +
  ...
  scale_fill_manual(name="Year", values=c("2018"="#CC79A7", "2019"="#009E73", "2020"="gray", "2021"="#0072B2", "2022"= "#F0E442", "2023"="purple3","2024"="darkorange" )) +
  scale_color_manual(name="Year", values=c("2018"="#CC79A7", "2019"="#009E73", "2020"="gray", "2021"="#0072B2", "2022"="#F0E442", "2023"= "purple3","2024"="darkorange")) +
  theme_bw() +
...
#####
#getting proportion of yes records in a week 
...
# Add a Date column based on the week
