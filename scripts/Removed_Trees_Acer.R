...
path.out <- "~/Google Drive/My Drive/LivingCollections_Phenology/Observing Lists/Acer/"

#Batch loading trees from the Acer tree observation lists and placing them in data frame dat.all
dat.all <- read_bulk(directory = "../LivingCollections_Phenology/Observing Lists/Acer", extension = ".csv", header= TRUE,)
head(dat.all)
