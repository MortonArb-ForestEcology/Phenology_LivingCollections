...
dat.all.stack[,c("collection", "Obs.List", "Observer", "Date.Observed", "Species", "PlantNumber", "Notes")] <- dat.all[,c("collection", "Obs.List", "Observer", "Date.Observed", "Species", "PlantNumber", "Notes")]
